...
Además de las funciones propias de cada tema, el módulo tiene dos subcarpetas transversales en `funciones/`:
...
- **`funciones/cuantizacion/`** — cuantización uniforme y no uniforme, desarrollada junto al tema 03 pero reutilizada por `funciones/fuente/` para audio e imagen. Ver su `README.md`.
